 ...
 */
 ...
 function formateo(){
     document.write('<h2><center>Operadores relacionales tipos distintos<table border="1">');
 ...
 function renglon(val1,val2,operador,resultado){
     ...
     document.write(typeof(val1)+" "+val1+"</td><td>"+operador+"</td><td>"+typeof(val2)+" "+val2+"</td><td>"+resultado+"</td></tr>");
 }
 ...
 variables(0b01001001,0b01001001);
